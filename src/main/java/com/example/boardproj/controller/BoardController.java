...
import com.example.boardproj.service.BoardImageSevervice;
...
public class BoardController {
    ...
    private  final BoardImageSevervice boardImageSevervice;
    ...
    public String registerPost(@Valid BoardDTO boardDTO, BindingResult bindingResult, MultipartFile[] multipartFile ){
        ...
        log.info("컨트롤러로 들어온값 : " + multipartFile);
    ...
    public String read(Long bno, Model model, PageRequestDTO pageRequestDTO){
        ...
        try {
            ...
            List<BoardImageDTO> boardImageDTOList=
                    boardImageSevervice.boardImageread(bno);
            log.info("컨트롤러에서 서비스 read() 불러온값 : " );
            log.info(boardDTO);
            model.addAttribute("boardDTO", boardDTO);
            model.addAttribute("boardImageDTOList", boardImageDTOList);
